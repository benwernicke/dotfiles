...
/* tagging */
static const char* tags[] = { "ʕ·͡ᴥ·ʔ", "ԅ(≖‿≖ԅ)", "(╯°□°)╯", "(^з^)♪♬", "O=('-'Q)", "ʕ♥ᴥ♥ʔ" };
...
static Key keys[] = {
    ...
    { MODKEY | ShiftMask, XK_c, quit, { 0 } }, TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3) TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5)
};
